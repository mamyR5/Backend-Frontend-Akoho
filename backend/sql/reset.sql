DROP TABLE IF EXISTS AkohoMaty;
DROP TABLE IF EXISTS Incubation;
DROP TABLE IF EXISTS RecensementAtody;
DROP TABLE IF EXISTS Variation;
DROP TABLE IF EXISTS DetailLot;
DROP TABLE IF EXISTS IncubationLot;
DROP TABLE IF EXISTS EtatAtody;
